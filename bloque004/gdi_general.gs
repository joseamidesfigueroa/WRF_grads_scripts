...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#%% PRINCIPIO DEL CICLO PARA GENERAR 72 HORAS DE PRONOSTICO %%
#%%%%%%%%%%%% START 72 FORECAST HOURS OF CICLE %%%%%%%%%%%%%%%
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
# QUIZA NECESITES CAMBIAR ESTO!!!
# epotsfc = Temperatura en K 
# spfhprs = Humedad específica

# MAYBE YOU NEED CHANGE THIS!!!
# epotsfc = Equivalent Potential Temperature
...
'c'
'set grads off'
'color -25 65 5 -kind black->gray->slategray->mediumseagreen->gold->darkorange->red->darkmagenta'
'd GDIc'
'cbarnskip 1'
'set gxout contour'
'set ccolor 0'
...
tb=subwrd(x1,3)
t2=subwrd(x1,5)
'draw title GDI y lineas de viento a 850 para 't1' '
